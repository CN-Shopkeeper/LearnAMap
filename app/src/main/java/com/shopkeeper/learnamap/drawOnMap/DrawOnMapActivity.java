...
import com.shopkeeper.learnamap.drawOnMap.maps.TraceCorrectionActivity;

public class DrawOnMapActivity extends RedirectActivity {

    private final String[] names = {"绘制点标记", "绘制线", "绘制平面", "绘制热力图", "绘制3D模型", "轨迹纠偏"};
