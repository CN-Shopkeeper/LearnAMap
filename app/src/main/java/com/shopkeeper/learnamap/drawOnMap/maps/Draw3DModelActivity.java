...
public class Draw3DModelActivity extends MapActivity {
...
class CubeMapRender implements CustomRenderer {

    private final LatLng center = new LatLng(39.90403, 116.407525);// 北京市经纬度
